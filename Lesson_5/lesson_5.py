...
blank_list = []
big_list = [7, 336, 61,61, "--==--", 'spam', 'dev', 1.23]
# індексація, зрізи
print(big_list[1])
print(big_list[1:4])
print(big_list[-2])
...
int_list = [x**2 for x in range(25)]
print(int_list)
